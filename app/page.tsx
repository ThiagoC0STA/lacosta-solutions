...
import { Calendar, AlertTriangle, Users, FileText, TrendingUp, Clock, Sparkles, BarChart3, Gift, X } from "lucide-react";
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            {urgentCount > 0 && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-red-950/20 border border-red-900 hover:bg-red-950/30 transition-all cursor-pointer shadow-sm hover:shadow-md"
              >
          ...
          <Card className="p-8 border border-border bg-card shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden">
            ...
            <div className="mb-7 flex items-start justify-between relative z-10">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-500/10 border border-blue-500/30 flex items-center justify-center shadow-md">
        ...
        <div className="grid gap-5 lg:grid-cols-2">
                ...
                <div className="space-y-3 flex-1 relative z-10">
                  {topRenewals.slice(0, 5).map((renewal, index) => (
                    <motion.div
                      ...
                      className="flex items-center justify-between rounded-xl border border-border p-4 hover:border-blue-500/50 hover:bg-gradient-to-r hover:from-blue-500/10 hover:to-transparent transition-all cursor-pointer group shadow-sm hover:shadow-md"
                    >
          ...
          <motion.div variants={itemVariants}>
            <Card className="p-6 border border-border bg-card shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col relative overflow-hidden">
              ...
              <div className="mb-6 flex items-center gap-4 relative z-10">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500/20 to-purple-500/10 border border-purple-500/30 flex items-center justify-center shadow-md">
                ...
                <div className="space-y-3 flex-1 relative z-10">
                  {todaysBirthdays.slice(0, 5).map((client, index) => (
                    <motion.div
                      ...
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ delay: index * 0.05 }}
                      className="flex items-center justify-between rounded-xl border border-border p-4 hover:border-purple-500/50 hover:bg-gradient-to-r hover:from-purple-500/10 hover:to-transparent transition-all cursor-pointer group shadow-sm hover:shadow-md"
                    >
                      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <Dialog open={showUrgentActions} onOpenChange={setShowUrgentActions}>
          <DialogHeader>
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-red-950/20 flex items-center justify-center">
                  <AlertTriangle className="h-5 w-5 text-red-400" />
                </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="space-y-1 text-sm text-muted-foreground ml-4">
                            {action.policyNumber && (
                              <p>
                                <span className="font-medium">Apólice:</span> {action.policyNumber}
                              </p>
                            )}
                            {action.insurer && (
                              <p>
                                <span className="font-medium">Seguradora:</span> {action.insurer}
                              </p>
                            )}
                            {action.product && (
                              <p>
                                <span className="font-medium">Produto:</span> {action.product}
                              </p>
                            )}
                            <p>
                            ...
                            {action.client.phone && (
                              <p>
                                <span className="font-medium">Telefone:</span> {action.client.phone}
                              </p>
                            )}
                          </div>
                        </div>
