...
import { User, Phone, Mail, Calendar as CalendarLucide, X, Save } from "lucide-react";
...
export function ClientCreateModal({
  ...
  }, [name, phone, email, birthday, onCreateClient, onCreated, handleClose]);
                ...
                <div className="grid gap-3 sm:gap-4 grid-cols-1 md:grid-cols-2">
                  ...
                  <div className="space-y-2 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-muted/40 hover:bg-muted/60 transition-all hover:shadow-md border border-border/30">
                    ...
                    <Input
                      type="date"
                      value={birthday || ""}
                      onChange={(e) => setBirthday(e.target.value || undefined)}
                      className="font-semibold"
                    />
                  </div>
                </div>
